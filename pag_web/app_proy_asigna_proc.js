...
$("#" + id_ppto_ddl_asignaProc).change(function(){
	firebase.database().ref(rama_bd_obras_proy + "/" + $('#' + id_obra_ddl_asignaProc + " option:selcted").val() + "/presupuestos/" + $('#' + id_ppto_ddl_asignaProc + " option:selcted").val() + "/proceso").once('value').then(function(snapshot){
...
$('#' + id_asignar_button_asignaProc).on('click', function(){
	...
	firebase.database().ref(rama_bd_obras_proy + "/" + $('#' + id_obra_ddl_asignaProc + " option:selcted").val() + "/presupuestos/" + $('#' + id_ppto_ddl_asignaProc + " option:selcted").val() + "/proceso").set(proc);
