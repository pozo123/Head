                               ...
                               [
                                ...
                                [
                                    {  
                                        ...
                                        //function(currentPage, pageCount) { return { fontSize:8,alignment: 'center', text: (currentPage == 2) ? 'Av. Constituyentes 561 Int. 101a, Col. , Miguel Hidalgo, Ciudad de México, C.P. 11820, Tel. 6273 7900 , email: proyectos@headingenieria.mx' : '' }; },
                                    },
                                    '',
                                    '',
                                    '',
                                ...
                                [
                                    {  
                                        colSpan:6,
                                        border: [false, false, false, false],
                                        text: "Notas:" + "\n" +"\n" + "-Todas las cantidades o volumetrías fueron tomadas de acuerdo al proyecto enviado por el cliente el día " + fecha_nota.toLocaleDateString("es-ES",options),
                                        margin: [0,10],
                                        alignment: 'left',
                                        fontSize: 8,
                                    },
